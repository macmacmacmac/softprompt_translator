...
def run(args_list=None):
    ...
    parser.add_argument("--input", type=str, default="./master_verbalizations.json")
    parser.add_argument("--output", type=str, default="./master_verbalizations.json")
    ...
    for dataset in tqdm(data):
        ...
        mapper_prompt = str(dataset["mapper_verbalization"])
        inspect_prompt = str(dataset["inspect_verbalization"])
        fs_prompt = str(dataset["fs_verbalization"])
        ...
        for instance in instances:
            ...
            instance["inspect_pred"] = inspect_pred
            instance["fs_pred"] = fs_pred
            instance["gt_pred"] = gt_pred
