...
def run(args_list=None):
    ...
    parser.add_argument("--lora_dir", type=str, default="./shared/mapper_lora_weights")
    ...
    LORA_DIR = f"{args.lora_dir}/DPO_rougeL_{args.beta}/meta-llama/Llama-3.1-8B-Instruct"
    ...
    # Save to JSON
    output_dir = f"./shared/verbalizations/rougeL_z_W_DPO_{str(args.beta)}.json"
