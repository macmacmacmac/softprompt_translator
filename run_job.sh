...
#SBATCH --gres=gpu:1
#SBATCH -C A100
#SBATCH -o 75-start.out
#SBATCH -e 75-start.out
...
# -----------------------------
python -u -m run_experiment --scripts soft_prompt_mapper.supernat_instruct_DoD.train_softprompts --start_percent 75 --run_percent 25
